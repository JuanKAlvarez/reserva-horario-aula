                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-10">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- Text input-->
                                <div class="form-group">
                                <label class="col-md-4 control-label" for="numero_Estudiantes">Numero Estudiantes</label>  
                                <div class="col-md-4">
                                <input id="numero_Estudiantes" name="numero_Estudiantes" type="text" placeholder="Numero Estudiantes" class="form-control input-md" required="">
                                <span class="help-block">Numero Estudiantes</span>  
                                </div>
                                </div>
