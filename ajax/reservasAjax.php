...
switch ($method){
    case 'guardar':
        ...
        $objReserva->nombres   = $dataForm["fecha"];
        $objReserva->apellidos = $dataForm["docente"];
        $objReserva->telefono  = $dataForm["aula"];
        $objReserva->correo    = $dataForm["horario"];
        ...
        foreach ($list as $key ){
            $tabla .= '
                    <tr>
                        ...
                        <td id="fecha_'.$key['id'].'" >'.$key['fecha'].'</td>
                        <td id="docente_'.$key['id'].'" >'.$key['docente'].'</td>
                        <td id="aula_'.$key['id'].'" >'.$key['aula'].'</td>
                        <td id="horario_'.$key['id'].'" >'.$key['horario'].'</td>
                        <td> 
    ...
    case 'editar':
        ...
        $objReserva->nombres   = $dataForm["nombres"];
        $objReserva->apellidos = $dataForm["apellidos"];
        $objReserva->telefono  = $dataForm["telefono"];
        $objReserva->correo    = $dataForm["correo"];
